...
def main():
    ...
    parser.add_argument('filename', type=str, default='test/E143_TEline-ESR-72Ge.lpp',
                        help='Path of the LISE file you want to read.')
    parser.add_argument('-n', '--nuclei', type=str, nargs='?',
                        help='Nuclei name to get its info.')
    
    parser.add_argument('-i', '--ian',
                        help='Get information for all the nuclei in the LISE file', action='store_true')
